...
subprocess.run(f'pbjs {proto_path} -t static-module -w es6 -o {proto_out}/compiled.js {protos}')
subprocess.run(f'pbts -o {proto_out}/compiled.d.ts {proto_out}/compiled.js')
generate(protos)
